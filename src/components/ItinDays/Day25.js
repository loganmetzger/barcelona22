  ...
  return (
    <div className="day">
      ...
      <div>
        ...
        <p>
          Lot's of people will likely be arriving in Spain today, so we've left
          today as a beach day in Sitges to explore and hang out. This is a
          wonderful town full of lively restaurants/bars, and history
        </p>
      </div>

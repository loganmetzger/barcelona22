...
const Day26 = (props) => {
  return (
    <div className="day">
      <h2 className="day-header">May 26</h2>
      ...
      <div>
        <h4>Montserrat</h4>
        <p>
          We will be meeting at 8:30AM today in Sitges at LOCATION to hop on the
          bus and head to Montserrat
        </p>
        <p>
        ...
        <p>
          For those of you looking for an active day there is an option to do a
          small hike to the top, however there is also a cable car to the top if
          you'd like to enjoy the ride
        </p>
      </div>
